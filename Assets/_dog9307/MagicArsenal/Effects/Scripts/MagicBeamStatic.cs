...
public class MagicBeamStatic : MonoBehaviour
{
    ...
    private GameObject beamStart;
        public GameObject beamS { get { return beamStart; } }
    private GameObject beamEnd;
        public GameObject beamE { get { return beamEnd; } }
        private GameObject beam;
        public GameObject beamB { get { return beam; } }
    ...
    public void ApplyScale(float scaleFactor)
    {
        ...
        if (beamStart)
            beamStart.transform.localScale = scale;
        if (beamEnd)
            beamEnd.transform.localScale = scale;
    }
}
}